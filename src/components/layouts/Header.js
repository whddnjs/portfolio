function Header() {
  return (
    <header className="fixed top-0 right-10 w-[35%] h-[55px] bg-black/70 navbar text-white flex justify-around items-center text-xl rounded-b-3xl text-opacity-70">
      <div>
